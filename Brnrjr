...
local redzLib = {
  ...
  Themes = loadstring(game:HttpGet("https://raw.githubusercontent.com/Seven7-lua/RedzLibs/refs/heads/main/src/RedzlibV4/Themes.lua"))(),
  Flags = {},
  Save = {
    Theme = "Default",
    UISize = {550, 310},
  ...
  Icons = loadstring(game:HttpGet("https://raw.githubusercontent.com/Seven7-lua/RedzLibs/refs/heads/main/src/RedzlibV4/Icons.lua"))() --[[
